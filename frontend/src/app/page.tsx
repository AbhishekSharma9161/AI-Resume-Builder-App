...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-indigo-100">
      ...
      {/* Hero Section */}
      <section className="px-6 py-20 min-h-[calc(100vh-120px)] flex items-center text-center relative overflow-hidden bg-gradient-to-br from-cyan-100 via-blue-200 to-indigo-300">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto py-8">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-normal py-4">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-800 via-blue-600 to-purple-600">
              Build Your Perfect Resume with{" "}
            </span>
            <span className="relative inline-block text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 py-2 px-1">
              AI Magic
